...
# Populate the blog, news and twitter data
inData <- file("en_US.blogs.txt")
blogs <- readLines(inData)
close(inData)

inData <- file("en_US.news.txt", open="rb")
news <- readLines(inData)
close(inData)

inData <- file("en_US.twitter.txt")
twitter <- readLines(inData)
close(inData)
rm(inData)

source('functions/sampleData.R')

# This action is performed due to memory limitations
set.seed(1738)
blogsSample <- sampleData(blogs,percent = 0.1)
newsSample <- sampleData(news,percent = 0.08)
twitterSample <- sampleData(twitter,percent = 0.035)

save(blogsSample, newsSample, twitterSample, file = "sampleData_06162017.RData")

rm(list=ls())

load("sampleData_06162017.RData")
...
save(blogsClean, newsClean, twitterClean, file = "cleanData_06162017.RData")

rm(list = ls())



load("cleanData_06162017.RData")
...
save(dataBlogWords, dataNewsWords, dataTwitterWords, file = "txt2words_06162017.RData")
...
save(blogsCorpus, newsCorpus, twitterCorpus, file = "corpus234Gram_06162017.RData")
...
save(dataBlogWords, dataNewsWords, dataTwitterWords, file = "txt2wordsCorpus_06162017.RData")
...
save(raw2gramT, raw2gramN, raw2gramB, file = "raw2gram_06162017.RData")
...
save(raw3gramT, raw3gramN, raw3gramB, file = "raw3gram_06162017.RData")

rm(raw3gramT, raw3gramN, raw3gramB)


# Create raw 4gram variables
load("txt2wordsCorpus_06162017.RData")
rm(dataBlogWords, dataNewsWords)
raw4gramT <- getNGrams(dataTwitterWords, 4)
rm(dataTwitterWords)
save(raw4gramT, file = "raw4gram_06162017.RData")
rm(raw4gramT)
...
rm(dataBlogWords)
load("raw4gram_06162017.RData")
save(raw4gramB, raw4gramT, file = "raw4gram_06162017.RData")
...
rm(dataNewsWords)
load("raw4gram_06162017.RData")
save(raw4gramT, raw4gramN, raw4gramB, file = "raw4gram_06162017.RData")
...
load("raw2gram_06162017.RData")
table2gram <- table(c(raw2gramB, raw2gramN, raw2gramT))
save(table2gram, file = "raw2gramTable_06162017.RData")
rm(list=ls())

load("raw3gram_06162017.RData")
table3gram <- table(c(raw3gramB, raw3gramN, raw3gramT))
save(table3gram, file = "raw3gramTable_06162017.RData")
rm(list=ls())

load("raw4gram_06162017.RData")
table4gram <- table(c(raw4gramB, raw4gramN, raw4gramT))
save(table4gram, file = "raw4gramTable_06162017.RData")
rm(list=ls())
...
save(wf1gram, file = "raw1gramTableFilterd_06162017..RData")
rm(list = ls())

load("raw2gramTable_06162017.RData")
...
save(wf2gram, file = "raw2gramTableFilterd_06162917.RData")
rm(list=ls())

load("raw3gramTable_06162017.RData")
...
save(wf3gram, file = "raw3gramTableFiltered_06162017.RData")
rm(list=ls())

load("raw4gramTable_06162017.RData")
...
save(wf4gram, file = "raw4gramTableFiltered_06162017.RData")
rm(list=ls())
...
load("raw1gramTableFilterd_06162017..RData")
load("raw2gramTableFilterd_06162917.RData")
load("raw3gramTableFiltered_06162017.RData")
load("raw4gramTableFiltered_06162017.RData")
...
save(gram1, gram2, gram3, gram4, file = "divideNGram_06162017.RData")
...
save(tableNGram, file = "writeFinalTable_06162017.RData")
